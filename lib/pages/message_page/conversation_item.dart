...
class ConversationItem extends StatelessWidget {
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              avatarContainer(conversationItemData), //显示头像
              content(),                             //右则信息
            ],
          ),
        ),
  ...
  Widget clipRRectImg(){
    ...
    return ClipRRect(
      ...
      child: conversationItemData.isAvatarFromNet() ?  
                Image.network(conversationItemData.avatar,scale: 1.0, fit: BoxFit.cover,) : 
                Image.asset(conversationItemData.avatar, fit: BoxFit.cover,),
    );
  } 
